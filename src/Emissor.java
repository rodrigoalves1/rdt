...
public class Emissor {
	...
	// Numero a ser comparado com o randômico para saber se haverá perda ou não
	...
	public static void enviar() throws ClassNotFoundException, IOException{//Modulo para gerar numero randomico 
		...
		System.out.println("Requisição finalizada - esperando resposta");
		receber();

	}
	
	public static void receber() throws IOException, ClassNotFoundException{
		ModuloDescarte md = new ModuloDescarte();
		...
		while(!end){
			...
			// Espera por pacote
			System.out.println("Esperando pacotes da resposta");
		...
		FileOutputStream fos = new FileOutputStream("index.pdf");
